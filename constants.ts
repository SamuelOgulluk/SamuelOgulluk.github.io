...
export const TRANSLATIONS: { en: TranslationContent; fr: TranslationContent } = {
  en: {
    ...
    den: {
      ...
      about: "about — the human who built this den",
      kit: "skills — languages and tools",
      close: "close",
      back: "back to the den",
      window: "home — Paris, where I'm from",
      degree: "Degree",
      diploma: "education — the degrees on the wall",
      piano: "Lutra — the piano side of the den",
      guitar: "Lutra — guitar by the window",
      otterLines: [
        "kwek.",
        "that's Lutra. this is her chair.",
        "don't mix the pcb with the coffee.",
        "samuel just works here. i own the rug.",
        "paris looks soft at dusk. i like the chimneys.",
        "the synth is called Lutra. like me.",
  ...
  fr: {
    ...
    den: {
      ...
      about: "à propos — l'humain qui a construit ça",
      kit: "compétences — langages et outils",
      close: "fermer",
      back: "retour à la tanière",
      window: "chez moi — Paris, d'où je viens",
      degree: "Diplôme",
      diploma: "formation — les diplômes sur le mur",
      piano: "Lutra — le piano du bureau",
      guitar: "Lutra — la guitare près de la fenêtre",
      otterLines: [
        "kwek.",
        "c'est Lutra. cette chaise est à elle.",
        "mélange pas le pcb et le café.",
        "samuel travaille ici. le tapis est à moi.",
        "paris est doux au crépuscule. j'aime les cheminées.",
        "le synthé s'appelle Lutra. comme moi.",
