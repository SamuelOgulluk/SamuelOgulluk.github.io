...
export const TRANSLATIONS: { en: TranslationContent; fr: TranslationContent } = {
  en: {
    ...
    den: {
      ...
      otterLines: [
        "kwek.",
        "that's Lutra. she lives here.",
        "the water's cold. i like it.",
        "samuel just visits. this is my rock.",
        "don't open the toolbox unless you know.",
        "lutra means otter. obviously.",
        "if you wait, i go for a swim.",
      ],
    },
    about: {
      title: "About",
  ...
  fr: {
    ...
    den: {
      ...
      otterLines: [
        "kwek.",
        "c'est Lutra. elle habite ici.",
        "l'eau est froide. j'aime ça.",
        "samuel passe juste. ce rocher est à moi.",
        "n'ouvre pas la caisse si tu n'as pas le mot de passe.",
        "lutra veut dire loutre. évidemment.",
        "si tu attends, je vais nager.",
      ],
    },
    about: {
      title: "À propos",
